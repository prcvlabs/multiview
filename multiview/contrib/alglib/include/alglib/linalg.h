...
void _root_cmatrixherk(ae_task_data *_data, ae_state *_state);
...
void _root_rmatrixlu(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixlu(/* Complex */ ae_matrix* a,
    ...
    ae_int_t n,
    /* Integer */ ae_vector* pivots, ae_state *_state);
void _root_cmatrixlu(ae_task_data *_data, ae_state *_state);
...
ae_bool _pexec_hpdmatrixcholesky(/* Complex */ ae_matrix* a,
    ae_int_t n,
    ae_bool isupper, ae_state *_state);
void _root_hpdmatrixcholesky(ae_task_data *_data, ae_state *_state);
...
ae_bool _pexec_spdmatrixcholesky(/* Real    */ ae_matrix* a,
    ae_int_t n,
    ae_bool isupper, ae_state *_state);
void _root_spdmatrixcholesky(ae_task_data *_data, ae_state *_state);
...
void _root_rmatrixluinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_rmatrixinverse(/* Real    */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_rmatrixinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixluinverse(/* Complex */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_cmatrixluinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixinverse(/* Complex */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_cmatrixinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_spdmatrixcholeskyinverse(/* Real    */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_spdmatrixcholeskyinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_spdmatrixinverse(/* Real    */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_spdmatrixinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_hpdmatrixcholeskyinverse(/* Complex */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_hpdmatrixcholeskyinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_hpdmatrixinverse(/* Complex */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_hpdmatrixinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_rmatrixtrinverse(/* Real    */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_rmatrixtrinverse(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixtrinverse(/* Complex */ ae_matrix* a,
    ...
    ae_int_t* info,
    matinvreport* rep, ae_state *_state);
void _root_cmatrixtrinverse(ae_task_data *_data, ae_state *_state);
...
void _root_rmatrixqr(ae_task_data *_data, ae_state *_state);
...
void _pexec_rmatrixlq(/* Real    */ ae_matrix* a,
    ...
    ae_int_t n,
    /* Real    */ ae_vector* tau, ae_state *_state);
void _root_rmatrixlq(ae_task_data *_data, ae_state *_state);
...
void _root_cmatrixqr(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixlq(/* Complex */ ae_matrix* a,
    ...
    ae_int_t n,
    /* Complex */ ae_vector* tau, ae_state *_state);
void _root_cmatrixlq(ae_task_data *_data, ae_state *_state);
...
void _root_rmatrixqrunpackq(ae_task_data *_data, ae_state *_state);
...
void _pexec_rmatrixlqunpackq(/* Real    */ ae_matrix* a,
    ...
    ae_int_t qrows,
    /* Real    */ ae_matrix* q, ae_state *_state);
void _root_rmatrixlqunpackq(ae_task_data *_data, ae_state *_state);
...
void _root_cmatrixqrunpackq(ae_task_data *_data, ae_state *_state);
...
void _pexec_cmatrixlqunpackq(/* Complex */ ae_matrix* a,
    ...
    ae_int_t qrows,
    /* Complex */ ae_matrix* q, ae_state *_state);
void _root_cmatrixlqunpackq(ae_task_data *_data, ae_state *_state);
...
void _root_rmatrixsvd(ae_task_data *_data, ae_state *_state);
...
void _root_eigsubspacesolvedenses(ae_task_data *_data, ae_state *_state);
