    ...
    /* Real    */ ae_vector* x, ae_state *_state)
{
    ...
    _task->data.func = _root_rmatrixsolve;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.val = info;
    _task->data.parameters[4].value.val = rep;
    _task->data.parameters[5].value.val = x;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    info = (ae_int_t*)_task->data.parameters[3].value.val;
    rep = (densesolverreport*)_task->data.parameters[4].value.val;
    x = (ae_vector*)_task->data.parameters[5].value.val;
...
*************************************************************************/
void _root_rmatrixsolve(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_vector* b;
    ...
    b = (ae_vector*)_data->parameters[2].value.val;
    info = (ae_int_t*)_data->parameters[3].value.val;
    rep = (densesolverreport*)_data->parameters[4].value.val;
    x = (ae_vector*)_data->parameters[5].value.val;
    rmatrixsolve(a,n,b,info,rep,x, _state);
    _data->parameters[3].value.val = info;
    _data->parameters[4].value.val = rep;
    _data->parameters[5].value.val = x;
}
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixsolvefast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.val = info;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixsolvefast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_vector* b;
    ...
    /* Real    */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixsolvem;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.ival = m;
    _task->data.parameters[4].value.bval = rfs;
    _task->data.parameters[5].value.val = info;
    _task->data.parameters[6].value.val = rep;
    _task->data.parameters[7].value.val = x;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    info = (ae_int_t*)_task->data.parameters[5].value.val;
    rep = (densesolverreport*)_task->data.parameters[6].value.val;
    x = (ae_matrix*)_task->data.parameters[7].value.val;
    _e = (char*)_task->exception;
    ae_dispose_task(_task);
    ae_assert(_e==NULL, _e, _state);
}
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixsolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_matrix* b;
    ...
    a = (ae_matrix*)_data->parameters[0].value.val;
    n = _data->parameters[1].value.ival;
    b = (ae_matrix*)_data->parameters[2].value.val;
    m = _data->parameters[3].value.ival;
    rfs = _data->parameters[4].value.bval;
    info = (ae_int_t*)_data->parameters[5].value.val;
    rep = (densesolverreport*)_data->parameters[6].value.val;
    x = (ae_matrix*)_data->parameters[7].value.val;
    rmatrixsolvem(a,n,b,m,rfs,info,rep,x, _state);
    _data->parameters[5].value.val = info;
    _data->parameters[6].value.val = rep;
    _data->parameters[7].value.val = x;
}
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixsolvemfast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.ival = m;
    _task->data.parameters[4].value.val = info;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    info = (ae_int_t*)_task->data.parameters[4].value.val;
    _e = (char*)_task->exception;
    ae_dispose_task(_task);
    ae_assert(_e==NULL, _e, _state);
}
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixsolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_matrix* b;
    ...
    b = (ae_matrix*)_data->parameters[2].value.val;
    m = _data->parameters[3].value.ival;
    info = (ae_int_t*)_data->parameters[4].value.val;
    rmatrixsolvemfast(a,n,b,m,info, _state);
    _data->parameters[4].value.val = info;
}
    ...
    /* Real    */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixlusolvem;
    _task->data.parameters[0].value.val = lua;
    _task->data.parameters[1].value.val = p;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.val = b;
    _task->data.parameters[4].value.ival = m;
    _task->data.parameters[5].value.val = info;
    _task->data.parameters[6].value.val = rep;
    _task->data.parameters[7].value.val = x;
    ae_push_root_task(_task);
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixlusolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* lua;
    ae_vector* p;
    ae_int_t n;
    ...
    densesolverreport* rep;
    ae_matrix* x;
    lua = (ae_matrix*)_data->parameters[0].value.val;
    p = (ae_vector*)_data->parameters[1].value.val;
    n = _data->parameters[2].value.ival;
    b = (ae_matrix*)_data->parameters[3].value.val;
    m = _data->parameters[4].value.ival;
    info = (ae_int_t*)_data->parameters[5].value.val;
    rep = (densesolverreport*)_data->parameters[6].value.val;
    x = (ae_matrix*)_data->parameters[7].value.val;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixlusolvemfast;
    _task->data.parameters[0].value.val = lua;
    _task->data.parameters[1].value.val = p;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixlusolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* lua;
    ae_vector* p;
    ae_int_t n;
    ...
    /* Complex */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixsolvem;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.ival = m;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixsolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_matrix* b;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixsolvemfast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.ival = m;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixsolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_matrix* b;
    ...
    /* Complex */ ae_vector* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixsolve;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.val = info;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixsolve(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_vector* b;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixsolvefast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.val = b;
    _task->data.parameters[3].value.val = info;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixsolvefast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_vector* b;
    ...
    /* Complex */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixlusolvem;
    _task->data.parameters[0].value.val = lua;
    _task->data.parameters[1].value.val = p;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixlusolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* lua;
    ae_vector* p;
    ae_int_t n;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_cmatrixlusolvemfast;
    _task->data.parameters[0].value.val = lua;
    _task->data.parameters[1].value.val = p;
    _task->data.parameters[2].value.ival = n;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_cmatrixlusolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* lua;
    ae_vector* p;
    ae_int_t n;
    ...
    /* Real    */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixsolvem;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
    _task->data.parameters[4].value.ival = m;
    _task->data.parameters[5].value.val = info;
    _task->data.parameters[6].value.val = rep;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixsolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    a = (ae_matrix*)_data->parameters[0].value.val;
    n = _data->parameters[1].value.ival;
    isupper = _data->parameters[2].value.bval;
    b = (ae_matrix*)_data->parameters[3].value.val;
    m = _data->parameters[4].value.ival;
    info = (ae_int_t*)_data->parameters[5].value.val;
    rep = (densesolverreport*)_data->parameters[6].value.val;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixsolvemfast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixsolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Real    */ ae_vector* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixsolve;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
    ...
    _task->data.parameters[6].value.val = x;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    info = (ae_int_t*)_task->data.parameters[4].value.val;
    rep = (densesolverreport*)_task->data.parameters[5].value.val;
    x = (ae_vector*)_task->data.parameters[6].value.val;
    _e = (char*)_task->exception;
    ae_dispose_task(_task);
    ae_assert(_e==NULL, _e, _state);
}
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixsolve(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    n = _data->parameters[1].value.ival;
    isupper = _data->parameters[2].value.bval;
    b = (ae_vector*)_data->parameters[3].value.val;
    info = (ae_int_t*)_data->parameters[4].value.val;
    rep = (densesolverreport*)_data->parameters[5].value.val;
    x = (ae_vector*)_data->parameters[6].value.val;
    spdmatrixsolve(a,n,isupper,b,info,rep,x, _state);
    _data->parameters[4].value.val = info;
    _data->parameters[5].value.val = rep;
    _data->parameters[6].value.val = x;
}
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixsolvefast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixsolvefast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Real    */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixcholeskysolvem;
    _task->data.parameters[0].value.val = cha;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
    _task->data.parameters[4].value.ival = m;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixcholeskysolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* cha;
    ae_int_t n;
    ae_bool isupper;
    ...
    densesolverreport* rep;
    ae_matrix* x;
    cha = (ae_matrix*)_data->parameters[0].value.val;
    n = _data->parameters[1].value.ival;
    isupper = _data->parameters[2].value.bval;
    b = (ae_matrix*)_data->parameters[3].value.val;
    m = _data->parameters[4].value.ival;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_spdmatrixcholeskysolvemfast;
    _task->data.parameters[0].value.val = cha;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_spdmatrixcholeskysolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* cha;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Complex */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixsolvem;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixsolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixsolvemfast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixsolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Complex */ ae_vector* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixsolve;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixsolve(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixsolvefast;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixsolvefast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Complex */ ae_matrix* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixcholeskysolvem;
    _task->data.parameters[0].value.val = cha;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixcholeskysolvem(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* cha;
    ae_int_t n;
    ae_bool isupper;
    ...
    ae_int_t* info, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_hpdmatrixcholeskysolvemfast;
    _task->data.parameters[0].value.val = cha;
    _task->data.parameters[1].value.ival = n;
    _task->data.parameters[2].value.bval = isupper;
    _task->data.parameters[3].value.val = b;
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_hpdmatrixcholeskysolvemfast(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* cha;
    ae_int_t n;
    ae_bool isupper;
    ...
    /* Real    */ ae_vector* x, ae_state *_state)
{
    char *_e;
    ae_task_info *_task = ae_create_task(NULL, _state);
    _task->data.func = _root_rmatrixsolvels;
    _task->data.parameters[0].value.val = a;
    _task->data.parameters[1].value.ival = nrows;
    _task->data.parameters[2].value.ival = ncols;
    _task->data.parameters[3].value.val = b;
    _task->data.parameters[4].value.dval = threshold;
    _task->data.parameters[5].value.val = info;
    _task->data.parameters[6].value.val = rep;
    _task->data.parameters[7].value.val = x;
    ae_push_root_task(_task);
    ae_wait_for_event(&_task->done_event);
    info = (ae_int_t*)_task->data.parameters[5].value.val;
    rep = (densesolverlsreport*)_task->data.parameters[6].value.val;
    x = (ae_vector*)_task->data.parameters[7].value.val;
    _e = (char*)_task->exception;
    ae_dispose_task(_task);
    ae_assert(_e==NULL, _e, _state);
}
...
This method is called when worker thread starts working on root task.
*************************************************************************/
void _root_rmatrixsolvels(ae_task_data *_data, ae_state *_state)
{
    ae_matrix* a;
    ae_int_t nrows;
    ae_int_t ncols;
    ...
    ae_vector* x;
    a = (ae_matrix*)_data->parameters[0].value.val;
    nrows = _data->parameters[1].value.ival;
    ncols = _data->parameters[2].value.ival;
    b = (ae_vector*)_data->parameters[3].value.val;
    threshold = _data->parameters[4].value.dval;
    info = (ae_int_t*)_data->parameters[5].value.val;
    rep = (densesolverlsreport*)_data->parameters[6].value.val;
    x = (ae_vector*)_data->parameters[7].value.val;
