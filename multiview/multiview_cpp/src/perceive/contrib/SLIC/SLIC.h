...
// and Sabine Susstrunk, "SLIC Superpixels", EPFL Technical Report no. 149300,
// June 2010.
//===========================================================================
...
// NOTE
//
// We have changed all "unsigned int" to "uint32_t"
// All other changes are noted // Added AJM

#if !defined(_SLIC_H_INCLUDED_)
#define _SLIC_H_INCLUDED_

#include <algorithm>
#include <stdint.h> // Added/Change AJM
#include <string>
#include <vector>
...
class SLIC
{
 public:
   ...
   void DoSuperpixelSegmentation_ForGivenSuperpixelSize(
       ...
       const int width,
       const int height,
       int*& klabels, // Change AJM, only allocate if klabels==nullptr
       int& numlabels,
       const int& superpixelsize,
       const double& compactness);

   void DoSuperpixelSegmentation_ForGivenSuperpixelSize_LAB(
   ...
   // step*step*step)
   //============================================================================
   void DoSupervoxelSegmentation(uint32_t**& ubuffvec,
                                 const int& width,
                                 const int& height,
                                 const int& depth,
                                 int**& klabels,
   ...
   // Can also be used to draw boundaries around supervoxels, i.e layer by
   // layer.
   //============================================================================
   void DrawContoursAroundSegments(uint32_t*& segmentedImage,
                                   int*& labels,
                                   const int& width,
                                   const int& height,
 ...
 private:
   ...
   //============================================================================
   void PerformSuperpixelSLIC(std::vector<double>& kseedsl,
   ...
   //============================================================================
   void PerformSupervoxelSLIC(std::vector<double>& kseedsl,
                              std::vector<double>& kseedsa,
                              std::vector<double>& kseedsb,
                              std::vector<double>& kseedsx,
                              std::vector<double>& kseedsy,
   ...
   //============================================================================
   void GetKValues_LABXYZ(std::vector<double>& kseedsl,
                          std::vector<double>& kseedsa,
                          std::vector<double>& kseedsb,
                          std::vector<double>& kseedsx,
                          std::vector<double>& kseedsy,
   ...
   //============================================================================
   void PerturbSeeds(std::vector<double>& kseedsl,
                     std::vector<double>& kseedsa,
                     std::vector<double>& kseedsb,
                     std::vector<double>& kseedsx,
                     std::vector<double>& kseedsy,
   ...
   //============================================================================
   void DoRGBtoLABConversion(const uint32_t*& ubuff,
                             double*& lvec,
                             double*& avec,
                             double*& bvec);
   //============================================================================
   ...
   //============================================================================
   void DoRGBtoLABConversion(uint32_t**& ubuff,
                             double**& lvec,
                             double**& avec,
                             double**& bvec);
   //============================================================================
